...
def hacer_clic_en_imagen(nombre_imagen, descripcion="", tiempo_espera=3, region=None, multiple=False, click=True, tolerancia=None):
    """
...
############################  Se dismuyo la taza de fallo en la busqueda visual de las carpetas del correo, pues a veces hay carpetas con nombre muy parecidos confundiendo al codigo y haciendolo ir donde no debe    #########################################################