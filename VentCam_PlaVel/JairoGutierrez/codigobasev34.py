...
############################  Se incremento aun mas la tolerancia en la busqueda de anuncio y su eliminacion pues quedaba el codigo en un bucle infinito y se mejoro la busqueda de la ventana del aplicativo corparativo    #########################################################