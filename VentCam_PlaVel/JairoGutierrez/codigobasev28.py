...
def procesar_correos():
    ...
    for _ in range(20):
        ...
        while intentos < intentos_max and not correo_procesado_exitosamente:
            ...
            # --- Lógica para eliminar anuncios ---
            log("Buscando anuncios para eliminar...")
            ...
            if anuncio_encontrado:
                ...
                if hacer_clic_en_imagen("imagenes/eliminar.png", "Botón para eliminar anuncio", tiempo_espera=2):
                    log("Anuncio eliminado.")
                    time.sleep(2)
                else:
                    log("No se encontró el botón para eliminar el anuncio.")
            else:
                log("No se encontraron anuncios en el correo.")
...
############################  A veces microsofot outlook muesta anuncios, asi que se integro la funcion que los cierra antes de procesar los corres para evitar posibles acciones no deseadas sobre esos nuncios   #########################################################