    ...
    for _ in range(20):
        ...
        while intentos < intentos_max and not correo_procesado_exitosamente:
            ...
            if pyperclip.paste().strip() == "0":
                ...
                if hacer_clic_en_imagen("imagenes/seleccionar_carpeta_correos_revisados.png", "Seleccionar carpeta 'Correos revisados'"):
...
############################  Cuando valida si inicio session en lugar de darle clic en la coincidencia visual, solo si la encuentra cambia el valor vuleano para saber que si se inicio session y salir del bucle de intentar iniciar session    #########################################################