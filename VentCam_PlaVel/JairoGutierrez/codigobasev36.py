...
def procesar_correos():
    ...
    if not hacer_clic_en_imagen(
        "imagenes/seleccionar_carpeta_por_revisar.png", 
        "Seleccionar carpeta 'Correos por revisar'", 
        tiempo_espera=5, 
        tolerancia=0.75  # Tolerancia aumentada para esta búsqueda específica
    ):
    ...
    for _ in range(20):
        ...
        while intentos < intentos_max and not correo_procesado_exitosamente:
            ...
            if pyperclip.paste().strip() == "0":
                ...
                if hacer_clic_en_imagen(
                    "imagenes/seleccionar_carpeta_correos_revisados.png", 
                    "Seleccionar carpeta 'Correos revisados'",
                    tolerancia=0.75
                ):
